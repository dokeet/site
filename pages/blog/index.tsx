...
export default function Blog({ posts, drafts }: { posts: PostMeta[], drafts: PostMeta[] }) {
    return (
        <div className="mt-12">
            <h1>Blog</h1>
                ...
                {posts.map((post) => (
                    ...
                    >
                        <Link href={`/blog/${post.slug}`}>
                            <a>
                                <img src={post.image} alt={post.title} className="w-full max-h-[240px] object-cover rounded-lg mx-auto shadow-lg hover:shadow-2xll duration-300 transition filter saturate-50 hover:saturate-100" />
                                <div className="p-4">
